  ...
  return (
    <ScrollView style={{ flex: 1, padding: 20 }}>
      ...
      <Text style={{ marginTop: 10, fontSize: 16 }}>
        A ONG Amigo Fiel nasceu com a missão de transformar vidas: tanto de animais quanto de pessoas. Nosso trabalho é dedicado a oferecer um lar amoroso para cães e gatos de raça que foram abandonados, assim como para os vira-latas que encontramos nas ruas em situação de vulnerabilidade.
